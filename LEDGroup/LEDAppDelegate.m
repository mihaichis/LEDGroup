...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    LEDWelcomeViewController *landingPageVC = [[LEDWelcomeViewController alloc] initWithNibName:@"LEDWelcomeViewController" bundle:nil];
    
    self.navController = [[LEDNavigationController alloc] initWithRootViewController:landingPageVC];
